...
def app():
    ...
    60% of the dataset are graduate students, with 60% having Graduate Degrees, 22.8% with Undergraduate, 2.15% with PhDs\
    ...
    We must note that our dataset’s intrinsically imbalanced in terms of the candidates’ experience and gender, with nearly ~40% of the\
    ...
    Last New Job distribution was quite interesting, with 60% of the candidates only having worked at their current job for less than a year.\
    ...
    We include two gender-related distributions before deep-diving into it in Analysis 2, as the dataset has 1.5x more male than female candidates,\
    ...
    To classify the data scientists by their gender and education level, we added two drop-down menus, so the users can easily select\
    ...
    In the major graph, as was expected, the majority of data scientists studied STEM majors regardless of gender,\
    ...
    Lastly, to find which type of companies hire data scientists the most, we drew a graph that shows the company type and size\
